...
const WhatsAppFloat: React.FC<WhatsAppFloatProps> = ({
    ...
    return (
        <div className="fixed bottom-20 right-6 z-40 mb-3">
            <button
                onClick={handleWhatsAppClick}
                className="group relative flex h-12 w-12 items-center justify-center rounded-full bg-green-500 shadow-lg transition-all duration-300 hover:bg-green-600 hover:scale-110 hover:shadow-xl"
