...
const buildingsData = {
    ...
    2: {
        ...
        description:
            'Modern business premises featuring contemporary design with glass facades and steel construction. Ideal for office operations, showrooms, or mixed-use commercial activities. The building offers excellent natural lighting and professional aesthetics.',
        location: 'Business Park, Netherlands',
        yearBuilt: '2020',
        price: 'Contact for Price',
        images: [
            'https://www.tradingbv.com/wp-content/uploads/2025/02/4.png',
        ...
        specifications: [
            { name: 'Loading Dock', dimensions: '85 x 110 m', area: '9,350 m²' },
            { name: 'Office Wing', dimensions: '30 x 40 m', area: '1,200 m²' },
            { name: 'Reception Area', dimensions: '15 x 20 m', area: '300 m²' },
        ],
        totalArea: '9,350 m²',
        hasVideo: false,
        features: ['Glass facade', 'Modern design', 'Climate control', 'Reception area', 'Conference rooms', 'Parking facilities'],
    },
    3: {
        id: 3,
        title: 'Warehouse',
        ...
        description:
            'Robust warehouse facility with steel frame construction designed for heavy-duty storage and distribution operations. Features high ceilings, efficient layout, and excellent accessibility for logistics operations.',
        location: 'Logistics Hub, Netherlands',
        yearBuilt: '2019',
        price: 'Contact for Price',
        images: [
            'https://www.tradingbv.com/wp-content/uploads/2024/06/20240523_101558000_iOS-2048x1152.jpg',
            ...
            'https://images.unsplash.com/photo-1592744063296-d61b3d677a37?w=800&h=600&fit=crop',
            'https://images.unsplash.com/photo-1565058380520-3d8c6b5f3a66?w=800&h=600&fit=crop',
        ],
        specifications: [
            { name: 'Warehouse', dimensions: '44 x 88 m', area: '3,872 m²' },
            { name: 'Mezzanine', dimensions: '20 x 40 m', area: '800 m²' },
            { name: 'Office Block', dimensions: '15 x 20 m', area: '300 m²' },
        ],
        totalArea: '3,872 m²',
        hasVideo: false,
        features: ['High bay storage', 'Dock levelers', 'Sprinkler system', 'LED lighting', 'Security system', 'Easy truck access'],
    },
};
