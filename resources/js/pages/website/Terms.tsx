                ...
                <section className="bg-resteel-primary text-white">
                    <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                        <div className="mx-auto max-w-4xl">
                            <h1 className="mb-3 text-2xl leading-tight font-bold text-black sm:mb-4 sm:text-3xl md:text-4xl lg:text-5xl">
                                {t('terms_of_service')}
                            </h1>
                            {/* <p className="text-base text-black sm:text-lg lg:text-xl">{t('terms_last_updated')}</p> */}
                        </div>
                    </div>
                </section>
