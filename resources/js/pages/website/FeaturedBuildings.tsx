...
const getStatusStyles = (status: string) => {
    switch (status.toUpperCase()) {
        case 'SOLD':
            return { bg: 'bg-gray-500', pulse: 'bg-white/60' };
        case 'SALE':
        case 'ACTIVE':
        ...
        default:
            return { bg: 'bg-gray-500', pulse: 'bg-white' };
    }
};
            ...
            >
                ...
                <div className="relative h-40 flex-shrink-0 overflow-hidden sm:h-48">
                    ...
                    <div className="absolute top-3 left-3 sm:top-4 sm:left-4">
                        <span
                            className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-semibold text-white sm:px-3 sm:py-1 ${statusStyles.bg}`}
                        >
                            <span className={`mr-1 h-1.5 w-1.5 animate-pulse rounded-full sm:mr-2 sm:h-2 sm:w-2 ${statusStyles.pulse}`} />
                            ...
                            >
                                <div className="space-y-1 sm:space-y-2">
                                    {building.specifications.length > 0 ? (
                                        ...
                                        <div className="py-2 text-center text-xs text-gray-500 italic sm:text-sm">
