...
>
  {items.map((item) => (
    <Card
      key={item.id}
      className="min-w-[300px] max-w-sm h-[340px] flex flex-col justify-between snap-start shrink-0 bg-white border border-slate-200 shadow-md hover:shadow-lg transition-shadow duration-300"
    >
      {/* Image */}
